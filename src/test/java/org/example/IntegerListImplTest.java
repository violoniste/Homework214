...
class IntegerListImplTest {
    ...
    private static final Integer ITEM1 = 1;
    private static final Integer ITEM2 = 2;
    private static final Integer ITEM3 = 3;
    ...
    void add() {
        ...
        Integer actualAdd = out.add(ITEM1);
